package com.fj.footballmatchscedulefinal.ui.team.player.all
...
import com.fj.footballmatchscedulefinal.ui.team.player.PlayerAdapter
import com.fj.footballmatchscedulefinal.ui.team.player.detail.PlayerDetailActivity
...
class PlayerActivity : AppCompatActivity(), PlayerView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val i = intent
        id = i.getStringExtra(Const.TEAM_ID_KEY)

        adapter = PlayerAdapter(this, player) {
            startActivity<PlayerDetailActivity>(Const.PLAYER_ID_KEY to "${it.idPlayer}")
        }
